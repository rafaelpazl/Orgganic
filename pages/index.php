...
?>
  ...
  <section class="saving_section" id="saving_section">
    <div class="box">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="img-box">
              <img src="../images/section1.jpg" alt="" width="10%" height="10%">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="detail-box">
...
Nosso trampo ta no hype, irmão! É o traje certo pro mano certo, valeu? Descubra o conforto, estilo e atitude em cada trampo da <strong>Ogganic</strong>.
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              <h5>
                Entregamos os panos onde você estiver
              </h5>
              <p>
                Frete grátis pra Feira de Santana
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Contamos com um dos melhores panos do mercado!
              </p>
            </div>
          </div>
        </div>
  ...
  <section class="info_section  layout_padding2-top">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <form action="https://formsubmit.co/rafaelpaz10rpp@hotmail.com" method="POST">
    ...
    <footer class=" footer_section">
      <div class="container">
        <p>
        &copy; <span id="displayYear"></span>Orgganic 2024 Todos os direitos reservados.<br> Feito por
