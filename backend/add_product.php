...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($userId) {
        ...
        $sql = "INSERT INTO product (id, title, description, price, discount, sku, qnt_storage, main_image, additional_images, user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $additionalImagesStr = implode(',', $additionalImages);
                    ...
                    // Bind parameters
            mysqli_stmt_bind_param($stmt, "sssddsdsss", $productId, $title, $description, $price, $discount, $sku, $qnt_storage, $mainImage, $additionalImagesStr, $userId);
