  ...
  <style>
   ...
   <body>
     <span class="top-nav">       
       ...
       <img class="logotipo" src="images/LOGOOblack.png" alt="Orgganic">
      ...
      <div class="container nav-containter">
       <nav class="navbar navbar-expand-lg navbar-dark" id="mainNav">
           <div class="container">
               <a class="navbar-brand " href="https://pazwebagencia.com.br/"><img class="logo-nav" src="images/LOGOO.png" height="90px" alt="Pazweb"/></a>
               ...
               <div class="collapse navbar-collapse" id="navbarResponsive">
                  <div class="float-left">
                     <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0 l-flex">
                         <li class="nav-item"><a class="nav-link" href="#services">Panos</a></li>
                         <li class="nav-item"><a class="nav-link" href="#portfolio">OGGNC</a></li>
  ...
  <section class="product">
    <main class="container row">
      ...
      <div class="left-column col-md-8">
        <img data-image="black" src="images/section1.1.jpg" alt="">
      ...
      <div class="right-column col-md-4">
        ...
        <div class="product-description">
          <span>Camisa Orgganic OVERSIZED</span>
          <h1>As asas que me defendem</h1>
          <p>Camisa que acompanha a modelagem Oversized pra te deixar forte.
<br>
                - Reforço ombro a ombro
<br>            - Etiquetagem Interna
<br>            - Estampa em SILK ( Método validado em qualidade )
<br>            - Produzida na malha 100% algodão da Menegotti
<br>            - Fio 30.1
            
<br>           A Menegotti é uma das pioneiras na questão de qualidade da matéria-prima.</p>
        </div>
        ...
        <div class="product-configuration">
          ...
          <div class="cable-config">
            ...
            <a onclick="openModal()"> Informações específicas</a>
      ...
      <footer class=" footer_section">
        <div class="container">
          <p>
            ...
            <strong><a href="https://pazwebagencia.com.br" target="_blank">Pazweb</a></strong>
          </p>
        </div>
      </footer>
      <!-- footer section -->
